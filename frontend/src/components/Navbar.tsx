...
import { Stethoscope, Award, Calculator, BookOpen, ShieldCheck, Users, Shield, Calendar, Menu, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="bg-emerald-500/20 text-emerald-400 text-[10px] font-bold px-1.5 py-0.5 rounded uppercase tracking-widest border border-emerald-500/30">CONSULTANCY</span>
            </div>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-bold rounded-lg shadow-lg shadow-emerald-900/30 hover:shadow-emerald-700/40 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
          >
